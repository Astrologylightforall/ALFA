...
export default function ServicesPage() {
  ...
  return (
    <>
      {/* Hero */}
      <section className="relative h-[40vh] min-h-[300px] flex items-center justify-center text-center px-4 overflow-hidden bg-primary-bg mt-[-6rem]">
      ...
      <section className="py-12 md:py-20 bg-secondary-bg px-4 border-t border-border-accent">
        <div className="max-w-6xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {filteredServices.map((service, index) => {
              const IconComponent = (LucideIcons[service.icon as keyof typeof LucideIcons] || LucideIcons.FileText) as React.ComponentType<{ size?: number }>;
