...
export default function AboutPage() {
  ...
  return (
    <>
      ...
      {/* Bio Section */}
      <section ref={bioRef} className="py-16 md:py-24 bg-secondary-bg px-4 border-t border-white/5 relative z-10">
          ...
          <div className="space-y-8 font-body text-[15px] md:text-lg text-cream/80 leading-relaxed order-1 lg:order-2 pt-4">
            ...
            <div className="space-y-6">
              ...
              <p className="bio-para bg-surface/40 p-6 rounded-2xl border border-border-accent shadow-inner text-cream/90 italic">
                &ldquo;My philosophy centers on transparency and support. I believe remedies should be practical, straightforward, and rooted in personal growth rather than fear. Every individual&apos;s chart is unique, and so are the solutions.&rdquo;
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Expertise Chips */}
      <section ref={expertiseRef} className="py-16 md:py-24 bg-primary-bg px-4 relative overflow-hidden border-t border-white/5">
      ...
      {/* Values Grid */}
      <section ref={valuesRef} className="py-16 md:py-24 bg-secondary-bg px-4 border-t border-white/5 z-10 relative">
      ...
      <section className="py-24 text-primary-bg px-4 text-center overflow-hidden relative" style={{ backgroundImage: "linear-gradient(135deg, #C9A84C 0%, #E8C96A 50%, #C9A84C 100%)" }}>
        <div className="max-w-4xl mx-auto space-y-8 relative z-10">
          ...
          <p className="font-body text-lg font-bold text-primary-bg/80 max-w-lg mx-auto">Book your free initial horoscope analysis with Manjul ji today.</p>
